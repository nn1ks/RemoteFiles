      ...
      bottomNavigationBar: Container(
        ...
        child: Theme(
          data: Theme.of(context).copyWith(
            bottomAppBarColor: _isSelectionMode ? Theme.of(context).accentColor : Theme.of(context).bottomAppBarColor,
            iconTheme: IconThemeData(color: _isSelectionMode ? Theme.of(context).accentIconTheme.color : Theme.of(context).primaryIconTheme.color),
          ),
          child: BottomAppBar(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      model.progressType == "download"
                                          ...
                                          : (model.progressType == "upload" ? "Uploading ${model.loadFilename}" : "Caching ${model.loadFilename}"),
                                      style: TextStyle(
                                        fontSize: 15.8,
                                      ...
                                      child: IconButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          for (int i = 0; i < widget.fileInfos.length; i++) {
                                            if (_isSelected[i]) {
                                              filePaths.add(widget.connection.path + "/" + widget.fileInfos[i]["filename"]);
              ...
              return SpeedDial(
                ...
                children: [
                  SpeedDialChild(
                    label: "Upload File",
                    labelStyle:
                        TextStyle(fontFamily: SettingsVariables.accentFont, fontWeight: FontWeight.w500, color: Theme.of(context).textTheme.body1.color),
